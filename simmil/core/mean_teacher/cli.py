...
from . import architectures, augmentations
...
def create_parser():
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='nctcrc',
                        choices=datasets.__all__,
                        help='dataset: ' +
                            ' | '.join(datasets.__all__) +
                            ' (default: imagenet)')
    parser.add_argument('--train-subdir', type=str, default='NCT-CRC-HE-100K',
                        help='the subdirectory inside the data directory that contains the training data')
    parser.add_argument('--eval-subdir', type=str, default='CRC-VAL-HE-7K',
