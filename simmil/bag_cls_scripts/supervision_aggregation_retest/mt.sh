...
--resume "/remote-home/my/GraphMIL/experiments/BackboneAggregation/NCTCRC/MT/$re_dir/$aggregator/model_best.pth" \
--log_dir "/remote-home/my/GraphMIL/experiments/BackboneAggregation/NCTCRC/MT/$re_dir/$aggregator/" \
