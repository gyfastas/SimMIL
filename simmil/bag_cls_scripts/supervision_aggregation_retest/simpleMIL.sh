...
--resume "/remote-home/my/GraphMIL/experiments/BackboneAggregation/NCTCRC/SimpleMIL_Last/$re_dir/$aggregator/model_best.pth" \
--log_dir "/remote-home/my/GraphMIL/experiments/BackboneAggregation/NCTCRC/SimpleMIL_Last/$re_dir/$aggregator/" \
...
--val_label_file "/remote-home/my/GraphMIL/samples/nctcrc_bags/BL50/bbs2000/test_ins.txt" \
-cn 2 \
