...
re_dir=$2
aggr=$3
CUDA_VISIBLE_DEVICES=$1 python main.py --runner assumption -b 4 -j 16 --gpu 0 -a resnet50 --lr 0.001 --assumption "std" -cn 2 \
--imgnet_pretrained \
...
--aggregator $aggr \
--log_dir "/remote-home/share/GraphMIL/experiments/BackboneAggregation/NCTCRC/pt/$re_dir/$aggr/" \
...
--aggregator $aggr \
-e \
--resume "/remote-home/share/GraphMIL/experiments/BackboneAggregation/NCTCRC/pt/$re_dir/$aggr/model_best.pth" \
--log_dir "/remote-home/share/GraphMIL/experiments/BackboneAggregation/NCTCRC/pt/$re_dir/$aggr/" \
"/remote-home/share/DATA/NCTCRC/" 
