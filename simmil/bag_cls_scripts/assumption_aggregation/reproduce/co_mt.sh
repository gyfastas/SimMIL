...
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/co/$re_dir/$aggregator/" \
...
--pos_targets 7 8 \
-e \
--resume "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/co/$re_dir/$aggregator/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/co/$re_dir/$aggregator/" \
--train-subdir "NCT-CRC-HE-100K" \
