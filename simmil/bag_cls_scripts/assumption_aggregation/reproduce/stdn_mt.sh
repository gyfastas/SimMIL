...
--assumption "std" \
--pos_targets 6 \
--load "/remote-home/share/GraphMIL/experiments/NCTCRC/MeanTeacher/Pretrained_200epochs/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/std-N/$re_dir/$aggregator/" \
...
--pos_targets 6 \
-e \
--resume "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/std-N/$re_dir/$aggregator/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/mt/std-N/$re_dir/$aggregator/" \
--train-subdir "NCT-CRC-HE-100K" \
