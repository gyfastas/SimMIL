...
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL/std/$re_dir/$aggregator/" \
...
--assumption "std" \
-e \
--resume "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL/std/$re_dir/$aggregator/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL/std/$re_dir/$aggregator/" \
--train-subdir "NCT-CRC-HE-100K" \
