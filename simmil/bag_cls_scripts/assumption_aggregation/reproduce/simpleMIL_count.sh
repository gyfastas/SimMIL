...
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL-$target/assumption-$d_target/count/$re_dir/$aggregator/" \
...
--pos_targets $d_target \
-e \
--resume "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL-$target/assumption-$d_target/count/$re_dir/$aggregator/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/share/GraphMIL/experiments/AssumptionAggregation/NCTCRC/SimpleMIL-$target/assumption-$d_target/count/$re_dir/$aggregator/" \
--train-subdir "NCT-CRC-HE-100K" \
