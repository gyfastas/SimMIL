...
--assumption "std" \
--pos_targets 6 \
--load '/remote-home/my/GraphMIL/experiments/NCTCRC/FSP/MTaugmentation/lincls_lr0.001_withval/checkpoint_0099.pth' \
--pretrained_type "oracle" \
--log_dir "/remote-home/my/GraphMIL/experiments/AssumptionAggregation/NCTCRC/Oracle/pos6/std/$re_dir/$aggregator/" \
...
--pos_targets 6 \
-e \
--resume "/remote-home/my/GraphMIL/experiments/AssumptionAggregation/NCTCRC/Oracle/pos6/std/$re_dir/$aggregator/model_best.pth" \
--pretrained_type "oracle" \
--log_dir "/remote-home/my/GraphMIL/experiments/AssumptionAggregation/NCTCRC/Oracle/pos6/std/$re_dir/$aggregator/" \
--train-subdir "NCT-CRC-HE-100K" \
