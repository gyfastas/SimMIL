...
--resume "/remote-home/my/GraphMIL/experiments/NCTCRC/SimpleMIL/MTaugmentation/lr0.001_withval/checkpoint_0099.pth" \
--log_dir "/remote-home/my/GraphMIL/experiments/InsAssumptionAggregation/NCTCRC/SimpleMIL_Last/$re_dir/$aggregator/" \
