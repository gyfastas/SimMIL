...
--resume "/remote-home/share/GraphMIL/experiments/BackboneAggregation/NCTCRC/Oracle/$re_dir/$aggregator/model_best.pth" \
--log_dir "/remote-home/share/GraphMIL/experiments/BackboneAggregation/NCTCRC/Oracle/$re_dir/$aggregator/" \
